...
<div class='boxadm'><i class="fa fa-folder-open"></i> Editar fornecedor</div>
<br/>
<?php 
...
try {	
$id = (int) $_GET['id'];
$stm = BD::conn()->prepare("UPDATE tb_fornecedor SET titulo = :titulo, slug = :slug, cidade = :cidade, categoria = :categoria, texto = :texto WHERE id = :id");			
...
echo "<meta http-equiv=refresh content='0;URL=gr_fornecedor.php'>";
...
<?php
$id = (int)$_GET['id'];
$sql = BD::conn()->prepare("SELECT * FROM tb_fornecedor WHERE id = ".$id." ");
$sql->execute();	
