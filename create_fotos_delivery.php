...
<?php
$id = (int)$_GET['id'];
$pegar_estoquea = BD::conn()->prepare("SELECT * FROM tb_multi_delivery WHERE id_img = ".$id." ");
...
<form action="remove-multi-fotos-delivery.php" method="post">
...
if($painel->Cadtb_multi_delivery($id_img, $files['tmp_name'], $files['name'])){
